					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<div style="text-align: center; padding: 30px; font-size: 10px;"><?php echo uilang("Developed by") ?><br><a target="_blank" class="textlink" style="color: lime;" href="https://www.instagram.com/rkykrnwn22_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">RICKY KURNIAWAN</a><br><br><br><a href="NULL" class="textlink" style="color: lime;"></a></div>
							</div>
						</div>
